...
* Game starts with randomly choosen start point (this icon ![rocket](https://github.com/Nuruddin999/Labirint/blob/master/src/rocket.svg)appers in start point)  on main board (3x3 grid)
